...
class get_stock_data():
    ...
    def __init__(self,):
        self.file_paths = {}
        self.trading_data_db = SqlAction('101.35.49.209', 'root', '543049601', 'trading_data')
    def get_train_test_data_new(self, batch_size, file_path, time_step = 60):
        ...
        if self_variable_name in self.file_paths:
            ...
            self.file_paths[self_variable_name] = cursor = DataFrame(self.trading_data_db.get_data_from_mysql('000001.SZ'))
...
def stock_lstm(self, ):
    ...
    model_save_path = "D:\\training_result\\stock_rnn_save.ckpt"  # os.path.join(basic_path, "stock_rnn_save.ckpt")
